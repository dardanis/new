...
<div class="login-box">
    ...
    <div class="card">
        <div class="card-body login-card-body">
            <p class="login-box-msg">New Co</p>

            <form action="controllers/LoginController.php?action=login" id="loginForm" method="post">
                ...
                if(isset($_SESSION['success'])){
                    echo "<div class='alert alert-success text-center'><strong>{$_SESSION['success']}</strong></div>";
                    unset($_SESSION['success']);
                }

                if(isset($_SESSION['error'])){
                    echo "<div class='alert alert-danger text-center'><strong>{$_SESSION['error']}</strong></div>";
